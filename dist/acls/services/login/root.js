...
var UserServicePermission = function (_Permission) {
	...
	function UserServicePermission(acl) {
		...
		return (0, _possibleConstructorReturn3.default)(this, (UserServicePermission.__proto__ || (0, _getPrototypeOf2.default)(UserServicePermission)).call(this, acl, '/login', ['POST']));
	}
