...
var UserThreadsServicePermission = function (_Permission) {
	...
	function UserThreadsServicePermission(acl) {
		...
		return (0, _possibleConstructorReturn3.default)(this, (UserThreadsServicePermission.__proto__ || (0, _getPrototypeOf2.default)(UserThreadsServicePermission)).call(this, acl, '/users/:email/threads', ['GET']));
	}
